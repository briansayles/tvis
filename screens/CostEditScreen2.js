        ...
        >
          ...
          >
            ...
            <GiftedForm.SelectWidget name='costType' multiple={false} title='Type'>
              <GiftedForm.OptionWidget title='Standard Buy-In' value='Buyin'/>
              <GiftedForm.OptionWidget title='Re-Buy' value='Rebuy'/>
              <GiftedForm.OptionWidget title='Add-on' value='Addon'/>
                ...
                this.props.updateCostMutation(
                  {
                    variables: {
                      ...
                      costType: values.costType ? values.costType.toString() : Cost.costType,
                    }
                  }
                ).then(() => {
